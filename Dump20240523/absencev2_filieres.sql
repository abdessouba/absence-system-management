...
CREATE TABLE `filieres` (
  ...
  PRIMARY KEY (`id`),
  KEY `filieres_secteur_id_foreign` (`secteur_id`),
  CONSTRAINT `filieres_secteur_id_foreign` FOREIGN KEY (`secteur_id`) REFERENCES `secteur` (`id`)
...
INSERT INTO `filieres` VALUES (1,'Développement digitale',1);
